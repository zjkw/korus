...
socks5_server_init_channel::socks5_server_init_channel(std::shared_ptr<reactor_loop> reactor, std::shared_ptr<socks5_server_auth> auth)
: _shakehand_state(SSS_NONE), _auth(auth), 
